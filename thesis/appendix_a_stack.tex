...
\begin{table}[h]
    ...
    \begin{tabular}{p{3.6cm} p{1.8cm} p{8.0cm}}
        ...
        Accelerate~\cite{accelerate2022} & $\geq$0.33.0 & Mixed-precision, gradient checkpointing \\
        ...
        Git & системный & Контроль версий кода и LaTeX-исходников \\
        ...
        s3cmd & системный & Синхронизация бинарных артефактов в shell-скриптах \\
        \bottomrule
    \end{tabular}
\end{table}
