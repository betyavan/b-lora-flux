...
Блоки = DS [0–18] (DA03), r = лучший из D-B, steps = лучший из D-C.
...
- **Phase 2** (D-A/B/C/P): 8/16 — D-A ✓ (лучший: DA03, DS [0–18], DINO=0.2568, FID=235.85); D-B ✓ (лучший: DB02, r=16, DINO=0.1835, FID=248.29)
